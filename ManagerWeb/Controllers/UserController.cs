...
namespace ManagerWeb.Controllers
{
    public class UserController : Controller
    {
        ...
        {
            UserInfo userInfo = _userInfoService.VerifyLogin(UserName, EncryptedPassword);
            if (userInfo != null)
            {
            ...
            {               
                return Redirect("~/Home/MyError?errorId=1");
            }
        ...
        public IActionResult Register(UserInfo userInfo)
        {
            ...
            {
                return Redirect("~/Home/MyError?errorId=2");
            }
